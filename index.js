...
const sessdata = config.SESSION_ID.replace("PANDEMONIUM-MD~", '');
...
console.log("CONNECTING PANDEMONIUM-MD 🧬...");
...
console.log('PANDEMONIUM-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ LITE-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ cshark ✅*
...
app.get("/", (req, res) => {
res.send("HEY, PANDEMONIUM-MD STARTED ✅");
});
