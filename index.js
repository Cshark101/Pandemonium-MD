...
console.log("[ ❄️ ] Session downloaded ✅")
  ...
  async function connectToWA() {
    ...
    console.log("[ ❄️ ] Connecting PANDEMONIUM MD to WhatsApp...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[ ❄️ ] Installing PANDEMONIUM MD Plugins...');
            ...
            console.log('[ ❄️ ] PANDEMONIUM MD Plugins installed successfully ✅');
            console.log('[ ❄️ ] PANDEMONIUM MD Bot connected to WhatsApp ✅');
            ...
            conn.sendMessage(ownerNumber + "2348101668050@s.whatsapp.net", {
